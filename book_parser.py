...
def get_book_info(book_url):
    ...
    book_text_url = urljoin(host_url,book_text_path)
    book_image_url = urljoin(host_url,book_image_path)
    book_info=(
            book_name.strip(),author.strip(),book_text_url,book_image_url,
            book_image_name,book_genres,book_comments      
             )  
    return book_info
