...
def get_book_info(book_url):
    ...
    book_text_relative_url = urljoin(book_url, book_text_path)
    book_image_relative_url = urljoin(book_url, book_image_path)
    book_info = (book_name.strip(), author.strip(), book_text_relative_url,
                 book_image_relative_url, book_image_name, book_genres,
                 book_comments)
    return book_info
